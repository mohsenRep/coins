const Category = () => {
  return (
    <div className="lg:static ">
      ...
      <div
        id="dropdownMenu"
        className="hidden  lg:grid lg:static lg:grid-flow-col lg:gap-2 lg:mb-8 lg:justify-stretch top-full left-0 right-0 mt-2 bg-white border lg:border-none border-gray-200 rounded-md shadow-lg lg:shadow-none"
      >
